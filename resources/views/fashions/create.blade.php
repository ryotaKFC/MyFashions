...
<x-form.base action="{{ route('fashions.store') }}" method="post" enctype="multipart/form-data">
    ...
    <x-form.input label="ハッシュタグ(3つまで)" name="tag1" type="text" placeholder="#" />
    <x-form.input name="tag2" type="text" placeholder="#" />
    <x-form.input name="tag3" type="text" placeholder="#" />
    <x-form.input label="日付" name="date" type="date" value="{{\Carbon\Carbon::today()->format('Y-m-d')}}" required />
